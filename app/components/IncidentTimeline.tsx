    ...
    <div className="mt-6 p-8 bg-black/70 rounded-xl border border-blue-950 space-y-8 animate-in fade-in slide-in-from-top-2 relative overflow-hidden">
      ...
      <div className="relative border-l border-gray-800 ml-3 space-y-10 pb-4">
        ...
        <div className="relative pl-6">
          ...
          <h4 className="text-white font-semibold text-lg tracking-wide mb-2">The "Rage-Tap" Anomaly</h4>
        ...
        <div className="relative pl-6">
          ...
          <h4 className="text-white font-semibold text-lg tracking-wide mb-2">The Invisible Wall</h4>
          <p className="text-gray-300 text-sm leading-relaxed">
        ...
        <div className="relative pl-6">
          ...
          <h4 className="text-red-400 font-semibold text-lg tracking-wide mb-2">Quantifiable Daily Bleed (£1,500/day)</h4>
          <p className="text-gray-300 text-sm leading-relaxed">
        ...
        <div className="relative pl-6">
          ...
          <h4 className="text-white font-semibold text-lg tracking-wide mb-2">The Strategic Anchor (£135,000/Quarter)</h4>
          <p className="text-gray-300 text-sm leading-relaxed">
        ...
        <div className="relative pl-6">
          ...
          <h4 className="text-blue-400 font-semibold text-lg tracking-wide mb-2">The Assumptive Close</h4>
          <p className="text-gray-300 text-sm leading-relaxed">
