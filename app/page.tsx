    ...
    <main className="flex min-h-[100dvh] w-full flex-col items-center bg-[#020205] text-white antialiased selection:bg-cyan-500/30 selection:text-cyan-200 overflow-x-hidden pb-24 relative">
      ...
      <div className="w-full max-w-5xl px-4 pt-40 sm:pt-56 pb-0 text-center z-10 space-y-8 sm:space-y-10 animate-fade-in">
        <div className="max-w-3xl mx-auto flex flex-col items-center">
          ...
          <div className="text-zinc-300 text-[14px] xs:text-sm sm:text-sm md:text-base tracking-wider max-w-[95vw] sm:max-w-2xl mx-auto pt-0 leading-relaxed px-2 sm:px-4 antialiased font-light">
            <span className="font-mono block sm:inline whitespace-normal sm:whitespace-nowrap">
              We Turn <span className="text-cyan-400 font-semibold drop-shadow-[0_0_15px_rgba(6,182,212,0.4)]">Websites into</span> <span className="text-blue-400 font-semibold drop-shadow-[0_0_15px_rgba(59,130,246,0.4)] inline-block whitespace-nowrap">Client Acquisition Machines</span>
            </span>
          </div>
        </div>
